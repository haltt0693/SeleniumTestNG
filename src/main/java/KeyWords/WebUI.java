...
//        System.out.println("Input text = " + text + " on field = " + by);
//        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(5));
//        wait.until(ExpectedConditions.visibilityOfElementLocated(by));
...
//
    public static String getValue(By by) {
        System.out.println("Get value of element: " + by);
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(5));
        wait.until(ExpectedConditions.visibilityOfElementLocated(by));
    ...
    public static String getTitle(By by) {
        System.out.println("Get title of element: " + by);
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(5));
        wait.until(ExpectedConditions.visibilityOfElementLocated(by));
        String title = driver.findElement(by).getAttribute("title");
...
//    }
    ...
    public static boolean verifyContains(String actual, String expected) {
        waitForPageLoaded();
        System.out.println("Verify contains: " + actual + " \uD83D\uDFF0 " + expected);
    ...
    public static void assertContains(String actual, String expected, String message) {
        waitForPageLoaded();
        System.out.println("Assert contains: " + actual + " \uD83D\uDFF0 " + expected);
        boolean check = actual.contains(expected);
    ...
    public static void assertNotContains(String actual, String expected, String message) {
        waitForPageLoaded();
        System.out.println("Assert NOT contains: " + actual + " >< " + expected);
        boolean check = actual.contains(expected);
